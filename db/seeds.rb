...
hugh = Actor.create!(name: "Hugh Laurie", a_list: true)
cranston = Actor.create!(name: "Bryan Cranston", a_list: true)
skarsgard = Actor.create!(name: "Alexander Skarsgård", a_list: true)
sutherland = Actor.create!(name: "Kiefer Sutherland", a_list: true)
westwick = Actor.create!(name: "Ed Westwick", a_list: true)
braff = Actor.create!(name: "Zach Braff", a_list: true)
odenkirk = Actor.create!(name: "Bob Odenkirk", a_list: true)
hall = Actor.create!(name: "Michael C. Hall", a_list: false)
hamm = Actor.create!(name: "Jon Hamm", a_list: true)
allen = Actor.create!(name: "Tim Allen", a_list: false)
romano = Actor.create!(name: "Ray Romano", a_list: false)
harris = Actor.create!(name: "Neil Patrick Harris", a_list: true)
harrelson = Actor.create!(name: "Woody Harrelson", a_list: true)
levi = Actor.create!(name: "Zachary Levi", a_list: false)
mcbrayer = Actor.create!(name: "Jack McBrayer", a_list: false)
charles = Actor.create!(name: "Josh Charles", a_list: false)
ferguson = Actor.create!(name: "Jesse Tyler Ferguson", a_list: false)
jacobson = Actor.create!(name: "Peter Jacobson", a_list: false)
